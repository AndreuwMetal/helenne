...
export const dictionary = {
  ...
  'story.reserveEyebrow': { es: '04 — Modelo LightBlue', en: '04 — The LightBlue model' },
  'story.reserveTitle1': { es: 'Llévatelo', en: 'Take it' },
  'story.reserveTitle2': { es: 'a casa', en: 'home' },
  'story.reserveText': {
    es: 'Rayas finas azules y blancas, acolchado y cremallera blanca. Cosido a mano, pieza a pieza.',
    en: 'Fine blue and white stripes, quilted, with a white zip. Sewn by hand, piece by piece.',
  },
