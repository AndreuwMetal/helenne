...
export const dictionary = {
  ...
  'story.eyebrow': { es: 'Taller textil — cosido a mano', en: 'Textile workshop — sewn by hand' },
  'story.side': { es: 'Estuches y neceseres', en: 'Pencil cases and pouches' },
  'story.title1': { es: 'Cosido a mano,', en: 'Sewn by hand,' },
  'story.title2': { es: 'sin prisa', en: 'unhurried' },
  'story.intro': {
    es: 'Neceseres y estuches cosidos pieza a pieza, con telas seleccionadas y acabados cuidados.',
    en: 'Pouches and pencil cases sewn piece by piece, with selected fabrics and careful finishes.',
  },
  'story.pieceTitle': { es: 'La pieza', en: 'The piece' },
  'story.detailEyebrow': { es: '03 — El detalle', en: '03 — The detail' },
  'story.detailTitle1': { es: 'Cada puntada,', en: 'Every stitch,' },
  'story.detailTitle2': { es: 'a mano', en: 'by hand' },
  'story.collectionTitle': { es: 'La colección', en: 'The collection' },
  'story.reserveEyebrow': { es: '04 — Modelo Azul', en: '04 — The Azul model' },
  'story.reserveTitle1': { es: 'Resérvalo', en: 'Reserve it' },
  'story.reserveTitle2': { es: 'antes que nadie', en: 'before anyone' },
  'story.reserveText': {
    es: 'El Modelo Azul llega pronto. Déjanos tu nombre y te guardamos uno por WhatsApp.',
    en: 'The Azul model is coming soon. Leave your name and we will keep one for you on WhatsApp.',
  },
  'story.reservePlaceholder': { es: 'Tu nombre', en: 'Your name' },
  'story.reserveButton': { es: 'Reservar', en: 'Reserve' },
  'story.reserveDone': { es: 'Anotado. Termina la reserva en WhatsApp.', en: 'Noted. Finish your reservation on WhatsApp.' },
  'story.footerCraft': { es: 'Cosido pieza a pieza', en: 'Sewn piece by piece' },
